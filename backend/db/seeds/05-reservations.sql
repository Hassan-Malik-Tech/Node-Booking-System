...
VALUES
  ...
  (
    ...
    (SELECT id FROM users WHERE (username = 'active_booking_user1') AND (deleted_at IS NULL) ),
    NULL,
    '2036-03-20T9:00:00Z',
    '2036-03-20T9:15:00Z',
    'active',
  ...
  (
    ...
    (SELECT id FROM users WHERE (username = 'active_booking_user2') AND (deleted_at IS NULL) ),
    NULL,
    '2036-03-20T9:15:00Z',
  ...
  (
    ...
    (SELECT id FROM users WHERE (username = 'active_booking_user2') AND (deleted_at IS NULL) ),
    (SELECT id FROM users WHERE (username = 'bob_username') AND (deleted_at IS NULL) ),
